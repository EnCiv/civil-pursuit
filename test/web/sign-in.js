! function () {
  ...
  describe( '[ Web / Sign In ]' , function () {
    ...
    it ( 'should hide the link to My Profile' , function ( done ) {

      var domain = new Domain().on('error', done);

      domain.run(function () {
        webdriver.client.getCssProperty('.topbar a[title="Profile"]', 'display',
          domain.intercept(function (display) {
            display.should.be.an.Object;
            display.should.have.property('value')
    ...
    it ( 'should show the link to Sign Out' , function ( done ) {

      var domain = new Domain().on('error', done);

      domain.run(function () {
        webdriver.client.getCssProperty('.topbar a[title="Sign out"]', 'display',
          domain.intercept(function (display) {
            display.should.be.an.Object;
            display.should.have.property('value')
              .which.is.exactly('none');
