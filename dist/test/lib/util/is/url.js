...
!(function () {
  ...
  function test__lib__util__is__url(done) {
    ...
    di(done, deps, function (domain, Test) {
      ...
      Test([test__lib__util__is__url____exists, test__lib__util__is__url____isA_Function, test__lib__util__is__url____failsIfNotString, test__lib__util__is__url____failsIfNotUrl, test__lib__util__is__url____okIfUrl], done);
    });
  }
