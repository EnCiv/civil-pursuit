    ...
    try {
      Promise.all([(0, _libUtilRandomString2['default'])(8), (0, _libUtilRandomString2['default'])(8)]).then(function (results) {
        try {
          ...
          var activation_key = _results[0];
          var activation_token = _results[1];

          _this.set('activation_key', activation_key);
          _this.set('activation_token', activation_token);
