...
!(function () {
  ...
  module.exports = function test___utils__downloadImage(done) {
    ...
    di(done, deps, function (domain, fs, httpGet, config) {
      ...
      httpGet(config['example image for test upload']).pipe(stream).on('finish', function () {
      ...
      */
      ...
      Test([test___utils__downloadImage____downloadTestImage, test___utils__downloadImage____imageIsDownloaded, test___utils__downloadImage____cleanOut], done);
    });
  };
})();