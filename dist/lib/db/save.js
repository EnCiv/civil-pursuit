...
!(function () {
  ...
  function saveDB(cb) {
    ...
    var models = ['Config', 'Country', 'Error', 'Item', 'User', 'Vote', 'Criteria', 'Feedback', 'Type'];
      ...
      Model.count(d.intercept(function (size) {
        ...
        for (var i = 0; i < split; i += 1000) {
          setTimeout((function () {
            ...
            Model.find().skip(this.i).limit(1000).sort({ _id: 1 }).exec(d.intercept(function (models) {
              ...
              if (i >= split) {
                ...
                stream.write(JSON.stringify(save, null, 2));
