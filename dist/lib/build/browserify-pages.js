    ...
    _fs2['default'].readdir(PAGES, function (error, files) {
      ...
      var promises = files.map(function (file) {
        return new Promise(function (ok, ko) {
          ...
          _fs2['default'].stat(_path2['default'].join(_file, 'ctrl.js'), function (error) {
      ...
      Promise.all(promises).then(function (results) {
        ...
        var promises = results.map(function (file) {
          return new Promise(function (ok, ko) {
            ...
            var cmd = (0, _util.format)('browserify %s -o %s', _path2['default'].join(file, 'ctrl.js'), _path2['default'].join(file, 'bundle.js'));
...
if (/browserify-pages\.js$/.test(process.argv[1])) {
  browserifyPages().then(function () {
    return console.log('browserified');
  }, function (error) {
