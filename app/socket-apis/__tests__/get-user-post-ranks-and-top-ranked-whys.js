...
test('5 have 2 why mosts, 2 have why leasts, 1 has 1 why most, 1 has 1 why least – nothing ranked', async () => {
  ...
  console.info('callback', callback.mock.calls[0][0])
  expect(callback.mock.calls[0][0]).toMatchObject({
    ranks: [],
    whys: [
      {
        _id: new ObjectId('677dabe4bbf89e246fb5571b'),
      ...
      {
        _id: new ObjectId('677dac057b7c673cd6ec8fb6'),
      ...
      {
        _id: new ObjectId('677dac1b8803a748276502f4'),
      ...
      {
        _id: new ObjectId('677dac4a10aed31e82dba548'),
      ...
      {
        _id: new ObjectId('677dac58d7456741b55053a7'),
      ...
      {
        _id: new ObjectId('677db801febc25e922d2d58c'),
      ...
      {
        _id: new ObjectId('677db8043b4c2fdbbd477bca'),
      ...
      {
        _id: new ObjectId('677db80c92384ffe785647ca'),
      ...
      {
        _id: new ObjectId('677db80f8bd4e35276036823'),
      ...
      {
        _id: new ObjectId('677db8105cbbab65c84defb4'),
