! function () {
  ...
  var _ = {
    ...
    'forgot password modal':              '#forgot-password.modal.in',
    'forgot password email':              '#forgot-password.modal.in input[type="email"][name="email"]',
    'forgot password email error':        '#forgot-password.modal.in input[type="email"][name="email"].error',
    'forgot password form':               '#forgot-password.modal.in form[name="forgot-password"]',
    'forgot password form section':       '#forgot-password.modal.in form[name="forgot-password"] .form-section',
    'forgot password email not found':    '#forgot-password.modal.in .forgot-password-email-not-found',
    'forgot password in progress':        '#forgot-password.modal.in .forgot-password-pending',
    'forgot password success':            '#forgot-password.modal.in .forgot-password-ok'
  };
