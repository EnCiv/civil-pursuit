! function () {
  ...
  module.exports = function (done) {
    ...
    Test.suite('User.removeCitizenship(user_id, country_id)', {
      ...
      'should be a function': function (done) {
        User.schema.statics.should.have.property('removeCitizenship').which.is.a.Function;
        done();
      },

      'should add country': function (done) {
      ...
      'should remove citizenship': function (done) {

        src.domain(done, function (domain) {
          User.removeCitizenship(user_id, country_id, domain.intercept(function (user) {
            ...
            user.citizenship.length.should.be.exactly(0);
