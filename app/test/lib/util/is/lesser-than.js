! function () {
 ...
 function test__lib__util__is__lesserThan (done) {
    ...
    di(done, deps, function (domain, Test) {
      ...
      Test([
          test__lib__util__is__lesserThan____exists,
          test__lib__util__is__lesserThan____isA_Function,
          test__lib__util__is__lesserThan____returnsAFunction,
          test__lib__util__is__lesserThan____tryWithNumber,
          test__lib__util__is__lesserThan____tryWithString
        ],
        done);
