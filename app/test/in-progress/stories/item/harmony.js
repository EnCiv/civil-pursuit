...
function test(props) {
  ...
  return testWrapper(
    ...
    wrappers => it => {
      ...
      it('should have a harmony button', () =>
      ...
      it('should click on harmony button', () =>
      ...
      it('should click on toggle create harmony', () =>
        wrappers.driver.click([
          selectors.item.id.prefix + locals.item._id,
          selectors.harmony,
      ...
      it('should create item',
        describe.use(() => createItem(wrappers.driver, [
          ...
          subject : 'Test harmony',
          description : 'Test harmony'
        }))
      );
      ...
      it('should say 1', () =>
        wrappers.driver.hasText([
          selectors.item.id.prefix + locals.item._id,
          '> .item-buttons ' + selectors.item.harmony,
          '> span span:first-child'
        ].join(' '), '1')
      );
