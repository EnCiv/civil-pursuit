...
function evaluate (evaluation, user, item, type) {
  ...
  return it => {
    it('should be an instance of Evaluator', () => {
    ...
    it('itemId', [ it => {
      ...
      it('should be the same than item', () => {
    ...
    it('userId', [ it => {
      ...
      it('should be the same than user', () => {
...
function test () {
  ...
  return testWrapper(
    ...
    wrappers => it => {
      ...
      it('should Evaluator be a class', () =>
        Evaluator.should.be.a.Function()
      );

      it('should Evaluation be a class', () => {
