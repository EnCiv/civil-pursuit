    ...
    if (!this.state.user['gps validated']) {
      ...
      gps = (
        <Row className="gutter">
          ...
          <Column span="50">GPS validated {this.state.user['gps validated']}</Column>
        </Row>
      )
    }
    ...
    return (
      <section>
        <section style={{ width: '50%', float: 'left' }}>
          <Image
            src="https://res.cloudinary.com/hscbexf6a/image/upload/v1423262161/gvmv05rqke71uqsh3qzq.png"
            responsive
          />
        </section>
        ...
        <section className="gutter">
          <h2>Residence</h2>
          <p>
            This information allows us to place you into the district, state, county, and city communities in which you
            belong. By using GPS validate - it provides a way to prevent people from impersonating a local resident.
          </p>
        </section>
