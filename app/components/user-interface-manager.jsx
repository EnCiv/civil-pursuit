...
class UserInterfaceManager extends React.Component {
    ...
    shouldComponentUpdate(newProps, newState) {
        ...
        if (!Object.keys(this.state.uim).every(key=>{let a=this.state.uim.key, b=newState.uim.key || null; if(a!=b) logger.info(a,"!=",b); return a==b})) {logger.info("yes"); return true};
