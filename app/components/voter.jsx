...
import DynamicSelector from './prof-components/dynamic-selector'
    ...
    return (
      <section>
        <section style={{ width: '50%', float: 'left' }}>
          <Image
            src="https://res.cloudinary.com/hscbexf6a/image/upload/v1423262642/p61hdtkkdks8rednknqo.png"
            responsive
          />
        </section>
        ...
        <section className="gutter">
          ...
          <p>
            ...
            participation in certain categories then we increase our efforts to get more participation there.
          </p>
        </section>
        ...
        <SelectorRow name="Registered Voter">
          <Select
            ...
            medium
            ref="registered"
            defaultValue={user.registered_voter}
            onChange={this.setRegisteredVoter.bind(this)}
          >
