                    ...
                    <div id="mc_embed_signup_scroll" class="civil-pursuit-title signup">
                      <div className="civil-pursuit-text-block email-block">
                        <div className="civil-pursuit-text-block email-form cf">                   
                          ...
                          <input className="namein" type="text" value="" name="LNAME" id="mce-LNAME" placeholder="Last name" />
                          <input className="subjectin" type="text" value="" name="MMERGE3" id="mce-MMERGE3" placeholder="Subject" />
                          <input className="messagein" type="text" value="" name="MMERGE4" id="mce-MMERGE4" placeholder="Message" />
