...
function calcNewLocation(props) {
  return (
    props.newLocation ||
    (props.panel && props.panel.parent && props.panel.parent.new_location) ||
    (props.parent && props.parent.new_location) ||
    null
  )
}
...
class RASPLoginPanel extends ReactActionStatePathClient {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if (user && newLocation) {
      ...
      if (harmony.length) rasp.toParent({ type: 'REDIRECT' })
    }
    ...
    if (rasp.redirect) {
      ...
      return (
        <TypeComponent
          ...
          component={this.props.harmony[0].component}
          panel={newPanel}
          {...newPanel}
          key="type-component"
        />
