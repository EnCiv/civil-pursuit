...
export class RASPRuleList extends ReactActionStatePathClient {
    ...
    actionToState(action,rasp) {
        ...
        if(action.type==="TOGGLE_QBUTTON") {
            ...
            delta.creator=false;
            this.qaction(()=>this.props.rasp.toParent(Object.assign({},action,{wasType: action.type, type: "DECENDANT_FOCUS"})),0); // forces update history
        } else if (action.type==="TOGGLE_CREATOR"){
            delta.creator= !rasp.creator;
            this.qaction(()=>this.props.rasp.toParent(Object.assign({},action,{wasType: action.type, type: delta.creator ? "DECENDANT_FOCUS" : "DECENDANT_UNFOCUS"})),0); // forces update history
