...
exports.panel = class PanelInstruction extends ReactActionStatePathFilter {
  ...
  actionFilters = {
    ...
    "NEXT_PANEL": (action, delta) => { delta.instruction=this.vM.unFocus(this.props.rasp); this.queueAction(action); return true; },  // the action will be consumed by the state change, so push the action again.
  }
