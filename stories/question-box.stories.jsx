...
Default.args = {
  ...
  description: {
    text: "This is a large-scale online discussion with the purpose of starting unbiased, and thoughtful conversations. ",
    underlinedText: "We’re asking about concerns, not solutions."
  },
  participants: 1009,
};
