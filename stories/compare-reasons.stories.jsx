...
const pointList = [
  {
    ...
    reasonPoints: { most: [pointOne, pointTwo, pointThree, pointFour, pointFive], least: [pointSix, pointSeven, pointEight, pointNine, pointTen] },
  },
  { subject: 'Headline Issue #2', description: 'Description for Headline Issue #2', reasonPoints: { most: [pointEleven, pointTwelve], least: [pointThirteen, pointFourteen] } },
  { subject: 'Headline Issue #3', description: 'Description for Headline Issue #3', reasonPoints: { most: [pointFifteen, pointSixteen], least: [pointSeventeen, pointEighteen] } },
]

export const threePointLists = { args: { pointWithWhyRankListList, side: 'most' } }

export const emptyPointList = { args: { pointList: [] } }

export const emptyArgs = { args: {} }

export const twoPointListsPlayThrough = {
  args: { pointList: pointList.slice(1, 3), side: 'least' },
  play: async ({ canvasElement }) => {
    ...
    expect(onDoneResult(canvas)).toMatchObject({ count: 5, onDoneResult: { valid: true, value: 100 } })
  },
}
